...
export const CreationKeyForm: React.FC<Props> = ({ onClose, onCreateKey }) => {
  ...
  return (
    <div className="flex flex-col gap-3 sm:w-[500px] w-full bg-[#131316] p-5 rounded-[12px]">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <div className="flex items-center gap-2 md:text-sm text-xs text-white">
          <div className="flex items-center justify-between gap-2 w-full md:p-3 p-2 bg-[#1a1a1d] rounded-md border border-[#232328]">
            Per Minute
            <input
                type="number"
                min="0"
                ...
                className="w-[50px] md:text-sm text-xs text-white outline-none"
            />
          </div>
          <div className="flex items-center justify-between gap-2 w-full md:p-3 p-2 bg-[#1a1a1d] rounded-md border border-[#232328]">
            Per Day
