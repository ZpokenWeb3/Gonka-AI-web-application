    ...
    return (
        <div className="flex items-center justify-between">
            <div className="flex flex-col gap-1">
                ...
                <p className="md:text-[16px] text-[13px] text-[#707070]">Integrate Gonka AI into your applications</p>
            </div>
            <Button onClick={() => setOpen(true)} className="md:w-[200px] w-[110px]" variant="secondary">
