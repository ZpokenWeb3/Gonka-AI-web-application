...
export const DepositCard = () => {
    ...
    return (
        <div className="relative flex flex-col gap-12 w-full h-[350px] md:p-8 p-5 border border-[#232330] rounded-xl overflow-hidden">
            <div className="
            ...
            <div className="flex items-center justify-between h-full py-5 md:px-[50px] z-2  w-full border-t border-[#232330]">
                <div className="flex flex-col items-center">
                    <h5 className="md:text-2xl text-xl font-semibold text-white">{balance.toFixed(2)}</h5>
                    <p className="text-sm text-[#c9c9c9]">Available</p>
                </div>
                <div className="flex flex-col z-2  items-center ">
                    <h5 className="md:text-2xl text-xl font-semibold text-white">0.00</h5>
