...
export const ChatWrapper = ({ chatId }: ChatWrapperProps) => {
    ...
    return (
        <div className="flex flex-col w-full flex-1">
            ...
            >
                {messages.length === 0 ? (
                    <div className="flex flex-col items-center md:gap-2 gap-1 p-10">
                        <Logo size={80} />
                        <h3 className="md:text-[35px] text-[28px] text-[#E0E4EB] font-semibold">
                            GONka
                        </h3>
                        <p className="md:text-sm text-xs font-medium text-[#73798C]">
