                    ...
                    <table className="w-full">
                        <tbody>
                            <tr className="border-b border-[#232328]">
                                <td className="p-3 w-[200px] text-white">ChatGPT</td>
                                ...
                                <td className="p-3 w-[200px] text-center text-white">812 req</td>
                            </tr>
                            <tr className="border-b  border-[#232328]">
                                <td className="p-3 w-[200px] text-white">Claude</td>
                                <td className="p-3 text-center">
                                    <div className="flex items-center justify-center gap-2">
                                        <div className="w-20 h-[20px] w-full rounded-sm border border-[#232328] relative overflow-hidden">
                            ...
                            <tr>
                                <td className="p-3 w-[200px] text-white">RedHat</td>
                                <td className="p-3 text-center">
                                    <div className="flex items-center justify-center gap-2">
                                        <div className="w-20 h-[20px] w-full rounded-sm border border-[#232328] relative overflow-hidden">
